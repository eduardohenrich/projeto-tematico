...
public class Natacao {
    ...
    // Construtor com ID
	public Natacao(int id, String nome, String primeiro, String segundo, String terceiro) {
		this.id = id;
		this.nome = nome;
	...
	public Natacao(String nome, String primeiro, String segundo, String terceiro) {
		this.nome = nome;
		this.primeiro = primeiro;
		this.segundo = segundo;
		this.terceiro = terceiro;
